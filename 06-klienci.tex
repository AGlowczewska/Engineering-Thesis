...
\begin{figure}[ht]
	...
	\caption{Struktura aplikacji \protect\newline źródło własne}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{Ekran logowania \protect\newline źródło własne}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{Sekcja czujników \protect\newline źródło własne}
\end{figure}
...
\begin{minipage}{.4\linewidth}
    ...
    \caption{Sekcja historii notyfikacji \protect\newline źródło własne}
    \label{img1}
\end{minipage}
\hspace{.05\linewidth}
\begin{minipage}{.4\linewidth}
    \includegraphics[width=\linewidth]{ios_screenshots/settings.png}
    \caption{Sekcja ustawień \protect\newline źródło własne}
    \label{img2}
\end{minipage}
\end{figure} 
...
\begin{figure}[ht]
	...
	\caption{Zużycie sieci podczas streamu \protect\newline źródło własne}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{Zużycie procesora i RAM podczas największego obciążenia \protect\newline źródło własne}
\end{figure}
