...
\begin{figure}
	...
	\subfigure{
	\label{fig:first}
	\includegraphics[width=3cm]{android-screenshots/Logowanie.png}}
	\qquad
	\subfigure{
	\label{fig:second}
	\includegraphics[width=3cm]{ios_screenshots/login.png}}
	\caption{Widok logowania w aplikacji Android oraz iOS}
\end{figure}
