...
\begin{figure}
   \centering
   \subfloat[Rysunek 1]{\includegraphics[width=3cm]{android-screenshots/Logowanie.png}}
   \hspace{5mm}
   \subfloat[Rysunek 2]{\includegraphics[width=3cm]{android-screenshots/Logowanie.png}}
   \qquad
   \subfloat[Rysunek 3]{\includegraphics[width=9cm]{web_screenshots/login.png}}
   \caption{Test}
   \label{fig:test}
\end{figure}
