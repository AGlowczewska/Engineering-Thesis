...
\begin{figure}[H]
   \centering
   \subfloat[Aplikacja Android]{\includegraphics[width=4cm]{android-screenshots/Logowanie.png}}
   \hspace{2cm}
   \subfloat[Aplikacja iOS]{\includegraphics[width=4cm]{ios_screenshots/login.png}}
   \qquad
   \subfloat[Aplikacja webowa]{\includegraphics[width=10cm]{web_screenshots/login.png}}
...
\begin{figure}[ht]
	...
	\caption{Widok logowania w aplikacji webowej}
	\label{web_login}
\end{figure}
