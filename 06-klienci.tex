...
\begin{figure}[H]
   ...
   \hfill
   \subfloat[Aplikacja webowa]{\includegraphics[height=4cm]{web_screenshots/login.png}}
...
\begin{figure}[H]
    ...
    \hfill
    \subfloat[Aplikacja webowa]{\includegraphics[height=4cm]{web_screenshots/rasp_view.png}}
...
\begin{figure}[H]
    ...
    \hfill
    \subfloat[Aplikacja webowa]{\includegraphics[height=4cm]{web_screenshots/rasp_notifications.png}}
...
\begin{figure}[H]
    ...
    \hfill
    \subfloat[Aplikacja webowa]{\includegraphics[height=4cm]{web_screenshots/rasp_rename.png}}
    \caption{Widok ustawień [źródło własne] }
    \label{fig:ustawienia}
\end{figure}

\section{Aplikacja Android}
\paragraph{Wybór narzędzi} \newline
...
\paragraph{Programowanie reaktywne} \newline
Aktualizacja danych z czujników, obsługa interfejsu użytkownika, zapytania API oraz komunikacja z usługami Firebase zrealizowane są zgodnie z paradygmatami programowania reaktywnego.
