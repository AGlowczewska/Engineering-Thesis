...
Ponadto, wykorzystano protokół HLS (HTTP Live Streaming), zapisywanie odbieranego obrazu, we wskazanej liczbie plików wideo o~określonej dłuśgoci. Gdy aplikacja kliencka odtwarza strumień wideo, w~rzeczywistości odbiera, strumieniowane po kolei, zapisane pliki ts. Wpływa to na opóźnienie odtwarzania, względem rzeczywistości, z~jednej strony, a~z drugiej,~dostarcza płynne wideo.
