...
\item Pamięć karta microSD (w~użytych w~tej pracy urządzeniach posłużono się kartami o wielkości 8 i~16 GB).
\item 40 GPIO
\end{itemize}
...
\begin{figure}[H]
    \centering
    \subfloat[GPIO]{\includegraphics[width=6cm]{gpio.png}}
    \hfill
    \subfloat[Wiringpi]{\includegraphics[width=4cm]{wiringpi.png}}
